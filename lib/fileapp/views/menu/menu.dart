...
class ViewerMenuBar extends StatefulWidget {
  final Widget child;

  const ViewerMenuBar({super.key, required this.child});

  @override
  State<ViewerMenuBar> createState() => _ViewerMenuBarState();
}

class _ViewerMenuBarState extends State<ViewerMenuBar> {
